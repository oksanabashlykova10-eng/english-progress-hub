...
export const teacherAvatarSrc=profile=>profile?.avatar?.value||DEFAULT_TEACHER_PROFILE.avatar.value;
...
export const studentAvatarSrc=student=>avatarPaths[student?.id==='ann'?profileStorage.getStudentAvatar():student?.avatarId]||avatarPaths['girl-1'];
